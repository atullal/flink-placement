...
public class Query5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int[] numbers = {10000, 10800000, 10000, 10800000};    // change input rate here
...
//        env.getCheckpointConfig().setCheckpointTimeout(100000);
        ...
        DataStream<Bid> bids = env.addSource(new BidSourceFunction(rates))
                .setParallelism(params.getInt("p-bid-source", 2))
                .name("SourceBid")
                //.slotSharingGroup("src")
                .assignTimestampsAndWatermarks(new TimestampAssigner())
                .name("TimestampAssigner");
                //.setParallelism(params.getInt("p-watermark", 2))
                //.slotSharingGroup("src");
        ...
        DataStream<Tuple2<Long, Long>> windowed = bids.keyBy((KeySelector<Bid, Long>) bid -> bid.auction)
                ...
                .name("SlidingWindow")
                .setParallelism(params.getInt("p-window", 10))
