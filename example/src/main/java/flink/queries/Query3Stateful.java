...
public class Query3Stateful {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int[] numbers = {80000, 3600000, 16000, 3600000, 80000, 3600000, 16000, 3600000};    // change input rate here
...
//        final int personSrcRate = params.getInt("person-srcRate", 10000);
        ...
        DataStream<Person> persons = env.addSource(new PersonSourceFunction(personSrcRates))
                ...
                .setParallelism(params.getInt("p-filter", 2))
        ...
        DataStream<Tuple4<String, String, String, Long>> joined = keyedAuctions.connect(keyedPersons)
                .flatMap(new JoinPersonsWithAuctions()).name("Incremental_join")
                .setParallelism(params.getInt("p-join", 4))
                .slotSharingGroup("join");

        GenericTypeInfo<Object> objectTypeInfo = new GenericTypeInfo<>(Object.class);
        joined.transform("DummyLatencySink", objectTypeInfo, new DummyLatencyCountingSink<>(logger))
                .setParallelism(params.getInt("p-sink", 2))
