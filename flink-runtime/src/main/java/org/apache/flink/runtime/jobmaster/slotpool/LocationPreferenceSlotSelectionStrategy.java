...
public abstract class LocationPreferenceSlotSelectionStrategy implements SlotSelectionStrategy {
    ...
    public Optional<SlotInfoAndLocality> selectBestSlotForProfile(
        ...
        LOG.info("mylog LocationPreferenceSlotSelectionStrategy selectBestSlotForProfile 1");
        ...
        LOG.info("mylog LocationPreferenceSlotSelectionStrategy selectBestSlotForProfile 2");
    ...
    public static LocationPreferenceSlotSelectionStrategy createDefault() {
        LOG.info("mylog LocationPreferenceSlotSelectionStrategy createDefault");
