...
public final class SlotRequestId extends AbstractID {
    ...
    private ExecutionVertexID slotExecutionVertexID;

    public ExecutionVertexID getslotExecutionVertexID() {
        return this.slotExecutionVertexID;
    }

    public void setslotExecutionVertexID(ExecutionVertexID sevid) {
        this.slotExecutionVertexID = sevid;
    }

    private String preferredLocation;

    public void setpreferredLocation(String pfl) {
        this.preferredLocation = pfl;
    }
